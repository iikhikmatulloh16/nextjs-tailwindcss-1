        ...
        <div className="prose max-w-none">
            ...
            <pre>
                <code className="language-html">
                    &lt;article class="prose"&gt;{"\n"}
                    {"  "}&lt;h1&gt;Garlic bread with cheese: What the science
                    tells us&lt;/h1&gt;{"\n"}
                    {"  "}&lt;p&gt;{"\n"}
            ...
            <p>
                ...
                <code>h4</code> elements are already so small that they are the
                same size as the body copy. What are we supposed to do with an{" "}
